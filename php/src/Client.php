 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/cocktail?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/cocktail';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CocktailClient] {$message}\n";
        }
    }
}
