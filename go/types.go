// Package cocktail provides a Go client for the Cocktail Recipe API.
//
// For more information, visit: https://apiverve.com/marketplace/cocktail?utm_source=go&utm_medium=readme
package cocktail
...
// Request contains the parameters for the Cocktail Recipe API.
//
// Parameters:
//   - name: string - The name of the cocktail for which you want to get the recipe (e.g., martini)
type Request struct {
...
// ResponseData contains the data returned by the Cocktail Recipe API.
type ResponseData struct {
	Count int `json:"count"`
	FilteredOn string `json:"filteredOn"`
	Cocktails []CocktailsItem `json:"cocktails"`
}

// CocktailsItem represents an item in the Cocktails array.
type CocktailsItem struct {
...
// IngredientsItem represents an item in the Ingredients array.
