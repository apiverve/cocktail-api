...
const (
	baseURL        = "https://api.apiverve.com/v1/cocktail"
	defaultTimeout = 30 * time.Second
)

// Client is the Cocktail Recipe API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Cocktail Recipe API client.
...
// Execute makes a request to the Cocktail Recipe API with typed parameters.
//
