...
```gradle
dependencies {
    implementation 'com.github.apiverve:cocktail-api:1.1.14'
}
```
...
```java
import com.apiverve.cocktail.CocktailRecipeAPIClient;
import com.apiverve.cocktail.APIResponse;
import com.apiverve.cocktail.APIException;

// Initialize the client
CocktailRecipeAPIClient client = new CocktailRecipeAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name", "martini");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/cocktail](https://docs.apiverve.com/ref/cocktail)
...
- **Documentation:** [https://docs.apiverve.com/ref/cocktail](https://docs.apiverve.com/ref/cocktail)
- **Issues:** [GitHub Issues](https://github.com/apiverve/cocktail-api/issues)
