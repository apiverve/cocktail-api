...
namespace APIVerve.API.CocktailRecipe
{
    ...
    /// <summary>
    /// Client for the CocktailRecipe API
    /// </summary>
    public class CocktailRecipeAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/cocktail";
        ...
        public CocktailRecipeAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CocktailRecipeAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CocktailRecipeAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CocktailRecipeQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CocktailRecipeQueryOptions options)
        {
        ...
        public ResponseObj Execute(CocktailRecipeQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CocktailRecipeQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CocktailRecipeQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CocktailRecipeQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CocktailRecipeQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CocktailRecipeQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CocktailRecipeQueryOptions options)
        {
